...
urlpatterns = [
   ...
   path("csehod/",views.csehod,name="csehod"),
   path('csefacilities/',views.csefacilities,name='csefacilities'),
   path('csepublications/',views.csepublications,name='csepublications'),
   path('cseplacement/',views.cseplacement,name='cseplacement'),
   path('cseclubs/',views.cseclubs,name='cseclubs'),
   path('ecehod/',views.ecehod,name='ecehod'),
   path('ecefaculty/',views.ece_faculty,name="ecefaculty"),
   path('ecefacilities/',views.ecefacilities,name='ecefacilities'),
   path('ecepublications/',views.ecepublications,name='ecepublications'),
   path('ecevission/',views.ecevission,name="ecevission"),
